...
<body>
	<div class="button" id="toggle_write_log" style="position:fixed;" >WRITE</div>

	<div id="write_log">
		<form action="wind_log.php" method="post"  enctype="multipart/form-data" >
	...
	<script>
	$( "#write_log" ).hide();
	$( "#toggle_write_log" ).click(function() {
	 $( "#write_log" ).toggle("fast");
	});
	</script>
